<template>
    <div
        ...
        :class="[isSideMenuOpen ? ' overflow-hidden' : '']"
    >
        <!-- Desktop sidebar -->
        <aside
            ...
            <div class="py-4 text-gray-500 dark:text-gray-400">
                ...
                <ul class="mt-6">
                    <li class="relative px-6 py-3">
                        <router-link
                            :to="{ name: 'dashboard' }"
                            class="link inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                        >
                            <svg
                                class="w-5 h-5"
                                aria-hidden="true"
                        ...
                        <li class="relative">
                            ...
                            <template v-if="isNotificationsMenuOpen">
                                <ul
                                    ...
                                    x-transition:leave-start="opacity-100"
                                    x-transition:leave-end="opacity-0"
                                    v-click-away="closeNotificationsMenu"
                                    @keydown.escape="closeNotificationsMenu"
...
<script setup>
import useDefaults from "@/composable/defaults.js";
